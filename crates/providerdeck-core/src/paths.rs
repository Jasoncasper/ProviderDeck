...
const APP_STATE_DIR: &str = ".providerdeck";
const SETTINGS_FILE: &str = "settings.json";
const LATEST_STATUS_FILE: &str = "latest-status.json";
const DIAGNOSTIC_LOG_FILE: &str = "providerdeck.log";
...
mod tests {
    ...
    fn default_settings_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".providerdeck/settings.json"));
    }
    ...
    fn default_latest_status_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".providerdeck/latest-status.json"));
    }
    ...
    fn default_diagnostic_log_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".providerdeck/providerdeck.log"));
    }
}
