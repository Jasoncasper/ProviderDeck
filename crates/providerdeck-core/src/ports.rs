...
pub const LAUNCHER_GUARD_PORT: u16 = 57420;
pub const MANAGER_GUARD_PORT: u16 = 57419;
pub const DEFAULT_HELPER_PORT: u16 = 57421;

static ACTIVE_HELPER_PORT: AtomicU16 = AtomicU16::new(DEFAULT_HELPER_PORT);
...
pub fn set_active_helper_port(port: u16) {
    ACTIVE_HELPER_PORT.store(port, Ordering::Relaxed);
}

pub fn active_helper_port() -> u16 {
    ACTIVE_HELPER_PORT.load(Ordering::Relaxed)
}
